...
createCollectable("steve", 430, 590); //
createCollectable("steve", 500, 630) ; //
createCollectable("steve", 800, 100) ; //
createCollectable("steve", 200,450) ; //
createCollectable("top", 300,1000) ; //
createCollectable("Kennedi", 400, 700) ; //
